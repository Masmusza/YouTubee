...
if [ -f "com.google.android.youtube.apk" ]; then
    ...
    java -jar revanced-cli.jar -m revanced-integrations.apk -b revanced-patches.jar \
        -e microg-support -e force-vp9-codec -e hide-cast-button -e swipe-controls -e amoled -e hide-autoplay-button -e hide-shorts-button -e disable-create-button -e custom-branding -e disable-fullscreen-panels ${patches[@]} \
        $EXPERIMENTAL \
        -a com.google.android.youtube.apk -o build/revanced-root.apk
    echo "Building Non-root APK"
    java -jar revanced-cli.jar -m revanced-integrations.apk -b revanced-patches.jar \
        -e force-vp9-codec -e hide-cast-button -e swipe-controls -e amoled -e hide-autoplay-button -e hide-shorts-button -e disable-create-button -e custom-branding -e disable-fullscreen-panels ${patches[@]} \
        $EXPERIMENTAL \
